...
1. seekx() - позволяет переместить в произвольную позицию внутри входное или выходного потока, для входного потока seekg(), для выходного seekp(), почему их два? Потому что файловый поток и входной и выходной, он хранит данные и теущей позиции для чтения и записи
