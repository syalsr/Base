...
В отличии от sequential контейнеров, асоциативные контейнеры не располагают свои элементы в линейной последовательности, представляют собой сбалансированное дерево
